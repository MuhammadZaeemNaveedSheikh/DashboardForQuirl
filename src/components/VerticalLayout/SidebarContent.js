      ...
      <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            <li className="menu-title">{props.t("Company Information")} </li>
            <li>
              <Link to="/#" >
                ...
                <span>{props.t("Company Module")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                  <Link to="/dashboard">{props.t("Company Information")}</Link>
                </li>
                <li>
                  <Link to="/dashboard-saas">{props.t("Team")}</Link>
                </li>
                <li>
                  <Link to="/dashboard-crypto">{props.t("Reports")}</Link>
                </li>
                {/* <li>
            ...
            <li className="menu-title">{props.t("Subscription")}</li>
{/* 
            <li>
              <Link to="/calendar" >
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/pages-pricing">{props.t("Payment Stripe")}</Link>
                </li>
                <li>
                  <Link to="/crypto-orders">{props.t("Subscription Info")}</Link>
                </li>
                {/* <li>
...
{/* 
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/form-editors">{props.t("WorkSpace Module")}</Link>
                </li>
                {/* <li>
